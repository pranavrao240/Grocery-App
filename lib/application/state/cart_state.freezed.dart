...
abstract class $CartStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Cart? cartModel, bool isLoading, String error});
...
class _$CartStateImpl with DiagnosticableTreeMixin implements _CartState {
  const _$CartStateImpl(
      {this.cartModel, this.isLoading = false, this.error = ''});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CartState(cartModel: $cartModel, isLoading: $isLoading, error: $error)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('cartModel', cartModel))
  ...
  @override
  int get hashCode => Object.hash(runtimeType, cartModel, isLoading, error);
